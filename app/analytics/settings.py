...
SECRET_KEY = 'django-insecure-m*61mydwt46911)9xoo-zudj)bp@t5sr)vya$krmb^p9keh$-w'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,
        'OPTIONS': {
            'environment': 'app.analytics.jinja2.environment'
        },
    },
    {
...
DATABASES = {
    'default': {
        ...
        'NAME': env("PSQL_DB_ANALYTICS"),
        'USER': env("PSQL_USER_ANALYTICS"),
        'PASSWORD': env("PSQL_PASS_ANALYTICS"),
        'HOST': env("PSQL_HOST_ANALYTICS"),
        'PORT': env("PSQL_PORT_ANALYTICS"),
    },
    'login': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': env("PSQL_DB_MAIN"),
        'USER': env("PSQL_USER_MAIN"),
        'PASSWORD': env("PSQL_PASS_MAIN"),
        'HOST': env("PSQL_HOST_MAIN"),
        'PORT': env("PSQL_PORT_MAIN"),
    },
}
